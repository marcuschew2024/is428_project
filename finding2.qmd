...
Using the journalist's complete record, no member's bias score is statistically extreme. Three members lean slightly toward fishing, three toward tourism — the committee is balanced, not captured. The confidence intervals confirm that individual deviations are within normal variance.

::: {.key-numbers}
**Bias score range (journalist):** approximately −0.4 to +0.4 across all 6 members
**Threshold:** |bias| > 0.15 = directional; within ±0.15 = balanced
**Net committee bias:** near zero — fishing-leaning and tourism-leaning members cancel out
:::
...
<img src="./images/Fishing vs Tourism participation (Journalist).png" style="width: 100%; height: auto;" alt="Tableau Schedule">
...
The scatter quadrant shows the committee's structure: three members fall in the upper-left (fishing-dominant) quadrant and three in the lower-right (tourism-dominant). No member occupies an extreme corner. This confirms the finding visually without relying on the bias score formula.
...
This is the most powerful chart in the project. It shows that FILAH's version inflates the apparent fishing-lean by 40–60%; TROUT's version inflates the apparent tourism-lean by the same amount. The journalist's version shows neither.
