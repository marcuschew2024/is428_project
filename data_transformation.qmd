...
> **Note:** `mc2_prepare.py` is located in `~/Desktop/vaProjectData/`, not in the Quarto project folder. The output CSVs in `tableau_data/` are what Tableau connects to directly.
